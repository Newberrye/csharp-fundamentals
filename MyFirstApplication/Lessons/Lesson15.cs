...
/*
 * Enums can be created either within a class or struct or in the namespace
 */
...
internal class Lesson15
{
    ...
    {
        Console.WriteLine(Day.Mon); // diplays value
        Console.WriteLine((int)Day.Tue); // displays number value
    }
    ...
    public void TupleExample()
    {
        ...
        Console.WriteLine($"Tuples with elements {beta.value1} and {beta.value2}");
    }
